...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (SONG.song.toLowerCase())
		{
			...
			case 'dadbattle':
				dialogue = [
					"You're a bigger pain in the ass than I would\never thought possible!",
					"Beep skip skadibily dap bap boop",
					"You're not leaving now, I don't think\nyou're able to anyway. ",
					"Skap skip bop beep bap",
				...
				dialogue = [
					...
					"...",
					"Hey dude...\nI know I lost",
					"But you're really giving me the creeps now",
					"beep. ",
					"...",
					"Alright weirdo",
					"I'm done with you",
					"let's see if you want to come back after this"
					//"*feroususly unsucks your cock*"
				];
				dface = [
		...
		else if (SONG.song.toLowerCase() == 'where-are-you' || SONG.song.toLowerCase() == 'kaio-ken' || SONG.song.toLowerCase() == 'eruption')
		{
			//dad.powerup = true;
			defaultCamZoom = 0.9;
			curStage = 'stage_2';
	...
	private function generateSong(dataPath:String):Void
	{
		...
		{
			//some 5note changes
			var mn:Int = 4 + 2*mania; //new var to determine max notes
