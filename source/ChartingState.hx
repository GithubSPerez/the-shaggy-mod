...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	function addSongUI():Void
	{
		...
		var m_check = new FlxUICheckBox(10, 45, null, null, "6 keys", 100);
	...
	function updateGrid():Void
	{
		...
		for (i in sectionInfo)
		{
			...
			var note:Note = new Note(daStrumTime, daNoteInfo % (4 + _song.mania * 2));
	...
	function selectNote(note:Note):Void
	{
		...
		{
			if (i.strumTime == note.strumTime && i.noteData % (4 + _song.mania * 2) == note.noteData)
			{
	...
	function deleteNote(note:Note):Void
	{
		for (i in _song.notes[curSection].sectionNotes)
		{
			if (i[0] == note.strumTime && i[1] % (4 + _song.mania * 2) == note.noteData)
			{
